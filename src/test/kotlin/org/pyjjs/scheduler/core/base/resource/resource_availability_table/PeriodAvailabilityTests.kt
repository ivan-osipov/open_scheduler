...
import org.pyjjs.scheduler.core.placement.time.PeriodicResourceAvailability as PA
...
class PeriodAvailabilityTests {
    ...
    fun addOnePeriodAvailabilityGenerateManyTimeParts() {
        val ts = TimeSheet()
        ts.addResourceAvailability(PA(start = 5, duration = 5, capacity = 1.0, interval = 6, end = 15))
