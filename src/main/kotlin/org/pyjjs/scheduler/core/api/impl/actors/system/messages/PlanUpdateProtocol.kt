...
class PlanUpdatedMessage(sender: ActorRef, val planChanges: SortedSet<PlanChange> = Sets.newTreeSet<PlanChange>(Comparators.TIMESTAMP_COMPARATOR)) : Message(sender)
